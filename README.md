...
| 字型設定 | 微調腳本 |
| -------- | -------- |
| [設定字型查找順序](https://samwhelp.github.io/note-about-mxlinux/read/subject/font/config/font-match-order.html) | [微調腳本](https://github.com/samwhelp/mxlinux-adjustment/tree/main/prototype/main/font-config/font-match-order) |
...
| 中文輸入法 | 微調腳本 |
| ---------- | -------- |
| [新酷音輸入法](https://samwhelp.github.io/note-about-mxlinux/read/subject/input-method/fcitx5/module/fcitx5-chewing.html) | [微調腳本](https://github.com/samwhelp/mxlinux-adjustment/tree/main/prototype/main/im-config/fcitx5/fcitx5-chewing) |
...
| 佈景主題 |
| -------- |
| [設定採用「GURB 佈景主題」](https://samwhelp.github.io/note-about-mxlinux/read/subject/grub.html) |
